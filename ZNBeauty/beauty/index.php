...
<html lang="en">
  ...
  <body>
    ...
    <section id="home-section" class="hero" style="background-image: url(images/17.png);" data-stellar-background-ratio="0.5">
	        ...
	        <div class="container-fluid p-0">
	          <div class="row d-md-flex no-gutters slider-text align-items-end justify-content-end" data-scrollax-parent="true">
		          ...
		          <!-- <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text mt-5">
		          		<span class="subheading">ZN BEAUTY</span>
			            
					
			            <p class="mb-4">We source and offer only the highest quality beauty products, carefully selected for their effectiveness, safety, and sustainability. </p>
	          ...
	          <div class="row d-flex no-gutters slider-text align-items-center justify-content-end" data-scrollax-parent="true">
		          ...
		          <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text mt-5">
			            ...
			            <p class="mb-4">This saloon provides huge facilities with advanced technology equipments and best quality service. Here we offer best treatment that you might have never experienced before.</p>
    	...
    	<div class="container-fluid px-0">
    		<div class="row no-gutters d-md-flex justify-content-end">
              ...
              ?>
					...
					<div class="one-third">
						<div class="img" style="background-image: url(images/12.jpg);">
						</div>
					</div>
    		</div>
    	</div>
